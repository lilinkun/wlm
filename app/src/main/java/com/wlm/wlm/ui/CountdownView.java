...
public class CountdownView extends View {
    ...
    public CountdownView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.CountdownView1);
        mTimeBgColor = ta.getColor(R.styleable.CountdownView1_timeBgColor, 0xFF444444);
        mTimeBgRadius = ta.getDimension(R.styleable.CountdownView1_timeBgRadius, 0);
        isShowTimeBgDivisionLine = ta.getBoolean(R.styleable.CountdownView1_isShowTimeBgDivisionLine, true);
        mTimeBgDivisionLineColor = ta.getColor(R.styleable.CountdownView1_timeBgDivisionLineColor, Color.parseColor("#30FFFFFF"));
        mTimeBgDivisionLineSize = ta.getDimension(R.styleable.CountdownView1_timeBgDivisionLineSize, dp2px(DEFAULT_TIME_BG_DIVISION_LINE_SIZE));
        mTimeBgSize = ta.getDimension(R.styleable.CountdownView1_timeBgSize, 0);

        isTimeTextBold = ta.getBoolean(R.styleable.CountdownView1_isTimeTextBold, false);
        mTimeTextSize = ta.getDimension(R.styleable.CountdownView1_timeTextSize, sp2px(12));
        mTimeTextColor = ta.getColor(R.styleable.CountdownView1_timeTextColor, 0xFF000000);
        isHideTimeBackground = ta.getBoolean(R.styleable.CountdownView1_isHideTimeBackground, true);
        isShowDay = ta.getBoolean(R.styleable.CountdownView1_isShowDay, false);
        isShowHour = ta.getBoolean(R.styleable.CountdownView1_isShowHour, false);
        ...
        isSuffixTextBold = ta.getBoolean(R.styleable.CountdownView1_isSuffixTextBold, false);
        mSuffixTextSize = ta.getDimension(R.styleable.CountdownView1_suffixTextSize, sp2px(12));
        mSuffixTextColor = ta.getColor(R.styleable.CountdownView1_suffixTextColor, 0xFF000000);
        mSuffix = ta.getString(R.styleable.CountdownView1_suffix);
        mSuffixDay = ta.getString(R.styleable.CountdownView1_suffixDay);
        mSuffixHour = ta.getString(R.styleable.CountdownView1_suffixHour);
        mSuffixMinute = ta.getString(R.styleable.CountdownView1_suffixMinute);
        mSuffixSecond = ta.getString(R.styleable.CountdownView1_suffixSecond);
        mSuffixMillisecond = ta.getString(R.styleable.CountdownView1_suffixMillisecond);
        mSuffixGravity = ta.getInt(R.styleable.CountdownView1_suffixGravity, 1);
        mSuffixLRMargin = ta.getDimension(R.styleable.CountdownView1_suffixLRMargin, -1);
        mSuffixDayLeftMargin = ta.getDimension(R.styleable.CountdownView1_suffixDayLeftMargin, -1);
        mSuffixDayRightMargin = ta.getDimension(R.styleable.CountdownView1_suffixDayRightMargin, -1);
        mSuffixHourLeftMargin = ta.getDimension(R.styleable.CountdownView1_suffixHourLeftMargin, -1);
        mSuffixHourRightMargin = ta.getDimension(R.styleable.CountdownView1_suffixHourRightMargin, -1);
        mSuffixMinuteLeftMargin = ta.getDimension(R.styleable.CountdownView1_suffixMinuteLeftMargin, -1);
        mSuffixMinuteRightMargin = ta.getDimension(R.styleable.CountdownView1_suffixMinuteRightMargin, -1);
        mSuffixSecondLeftMargin = ta.getDimension(R.styleable.CountdownView1_suffixSecondLeftMargin, -1);
        mSuffixSecondRightMargin = ta.getDimension(R.styleable.CountdownView1_suffixSecondRightMargin, -1);
        mSuffixMillisecondLeftMargin = ta.getDimension(R.styleable.CountdownView1_suffixMillisecondLeftMargin, -1);
        ta.recycle();

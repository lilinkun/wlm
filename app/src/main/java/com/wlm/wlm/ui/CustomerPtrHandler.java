...
public class CustomerPtrHandler extends FrameLayout implements PtrUIHandler {
    ...
    public CustomerPtrHandler(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        buildAnimation();
        View header = LayoutInflater.from(getContext()).inflate(R.layout.item_refresh_header, this);
